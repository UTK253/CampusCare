        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            <Card className="max-w-xl w-full shadow-lg">
                ...
                <CardContent className="pt-6">
                    <h2 className="text-xl font-medium mb-8 text-center">{questions[currentQuestion]}</h2>
                    <div className="grid grid-cols-1 gap-3">
                        {[
                            ...
                            <Button
                                key={opt.val}
                                variant="outline"
                                className="h-12 text-left justify-start px-4 hover:border-primary hover:bg-primary/5 transition-all"
